...
5. Coherent integration for third-party classes / interfaces / traits / enums available.

Key feature: it's fucking lightweight and readable. So no puzzles under the hood.

The library requires PHP 8.5 or higher. Code examples are available [here](https://github.com/Sunvas/eleanor-php-library-examples).
...
Библиотека работает на PHP 8.5 и выше. Примеры кода доступны [здесь](https://github.com/Sunvas/eleanor-php-library-examples).
